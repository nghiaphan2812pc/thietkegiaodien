...
if (isset($_GET['page_layout'])) {
    switch ($_GET['page_layout']) {
        case 'add': include_once 'add_customer.php'; break;
        case 'edit':include_once 'edit_customer.php'; break;
        case 'delete':include_once 'delete_customer.php'; break;
    }
}
?>
<!doctype html>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                          <a class="dropdown-item" href="all_customer.php?page_layout=delete&customerId=<?php echo $row['customerId']; ?>"><i class="fas fa-trash text-orange-dark"></i>Xóa</a>
                            <a class="dropdown-item" href="edit_customer.php?page_layout=edit&customerId=<?php echo $row['customerId']; ?>"><i class="fas fa-cogs text-dark-pastel-green"></i>Sửa</a>
                        </div>
                      </div>
                    </td>
                  </tr>
