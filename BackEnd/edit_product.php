<?php
    ...
    $sql_update = "SELECT * from products
                  ...
                  <form class="new-added-form" method="post">
                    <div class="row">
                      <div class="col-12 form-group">
                        ...
                        <input type="text" name="productName" required placeholder="" class="form-control" value="<?php echo $row['productName']; ?>">
                      </div>
                      <div class="col-12 form-group">
                        <label>Giá</label>
                        <input type="text" name="price" required placeholder="" class="form-control" value="<?php echo $row['price']; ?>">
                      </div>
                      <div class="col-12 form-group">
                        <label>Hãng</label>
                        <input type="text" name="brand" required placeholder="" class="form-control" value="<?php echo $row['brand']; ?>">
                      </div>
                      <div class="col-12 form-group">
                        <label>Mô tả</label>
                        <input type="text" name="description" required placeholder="" class="form-control" value="<?php echo $row['description']; ?>">
                      </div>
                      <div class="col-12 form-group">
                        <label>Ảnh sản phẩm</label>
                        <input type="text" name="image" required placeholder="" class="form-control" value="<?php echo $row['image']; ?>">
                      </div>
                      <div class="col-12 form-group">
...
<!-- Mirrored from www.radiustheme.com/demo/html/psdboss/akkhor/akkhor/teacher-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 02 Nov 2019 08:21:53 GMT -->
