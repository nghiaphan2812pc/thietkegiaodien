<?php
    ...
    if (isset($_POST['smb'])) {
        ...
        $rankId=$_POST['rankId'];
        $sql = "INSERT INTO discount(discountId, discount,rankId)
        VALUES(' $discountId', '$discount','$rankId')";
...
<!-- Mirrored from www.radiustheme.com/demo/html/psdboss/akkhor/akkhor/admit-form.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 02 Nov 2019 08:21:50 GMT -->
<!-- Added by HTTrack -->
            ...
            <form class="new-added-form" method="post">
              <div class="row">
                <div class="col-12 form-group">
                  ...
                  <input type="text" name="discountId" required placeholder="" class="form-control">
                </div>
                <div class="col-12 form-group">
                  <label>Giá trị khuyến mại (%)</label>
                  <input type="text" name="discount" required placeholder="" class="form-control">
                </div>
                <div class="col-12 form-group">
...
<!-- Mirrored from www.radiustheme.com/demo/html/psdboss/akkhor/akkhor/admit-form.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 02 Nov 2019 08:21:51 GMT -->
